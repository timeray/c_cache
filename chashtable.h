...
list_node_t* hashtable_get(const hashtable_t*, const key_t*);
void hashtable_put(hashtable_t*, const key_t*, list_node_t*);
bool hashtable_delete_entry(hashtable_t*, const key_t*);
